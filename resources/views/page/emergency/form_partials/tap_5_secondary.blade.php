                ...
                <div class="accordion-body">
                    <div class="row">
                        ...
                        <div class="col-sm-3 mt-4">
                            ...
                            <label class="col-form-label" for="multicol-username">Arsirkan bila ada luka
                                : jenis luka & ukurannya (panjang*lebar*dalam)
                            </label>
                            <label for="ketebalanPena">Ketebalan Pena:</label>
                            <input type="range" id="ketebalanPena" min="1" max="10" value="5">
                        ...
                        <div class="col-sm-9">
                            <canvas id="myCanvas" width="500" height="500"
                                style="border: 1px solid #000; background-image: url('{{ url('assets/img/anotomi-tubuh.png') }}'); background-position: center center; background-repeat: no-repeat;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
